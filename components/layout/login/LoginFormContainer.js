...
const LoginFormContainer = () => {
  return (
    <section
      className="flex-1 rounded-2xl px-12 py-20 flex flex-col justify-between h-full"
      style={{
    ...
    >
      <div>
        ...
        <p className="text-white text-sm w-fit mx-auto">
          Zk-based smart contracts wallet
        </p>
      </div>
